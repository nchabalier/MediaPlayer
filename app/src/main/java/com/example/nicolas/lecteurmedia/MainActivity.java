...
public class MainActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            String[] selection = {MediaStore.Audio.Media.DATA,MediaStore.Audio.Media.DISPLAY_NAME};
            String criteria= MediaStore.Audio.Media.IS_MUSIC + " !=0";

            ListSongs listSongs = new ListSongs();
            listSongs.selectAllSongs(this.getContext(), criteria, selection);
            List<String> names = listSongs.getName();
            //textView.setText(names.get(0));




            ListView listView1 = (ListView) rootView.findViewById(R.id.list_view);
